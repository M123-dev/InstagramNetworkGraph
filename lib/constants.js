...
const requests_per_hour = 500;

const username_value = process.env.IG_USERNAME;
const password_value = process.env.IG_PASSWORD;
const username_to_scrape =  process.env.IG_USERNAME_TO_SCRAPE;
...
const use_edge_mutual_followed_by = false;
...
// Normalizing the size of the nodes
const link_multiplier = 40;
const normal_link_value = 200;
const max_link_size = 1000;


module.exports ={
    username_value, password_value, headless, requests_per_hour, username_to_scrape, you_follow, use_edge_mutual_followed_by, min_node, max_node,link_multiplier, max_link_size, normal_link_value,
}