...
module.exports ={
    username_value, password_value, headless, requests_per_hour, username_to_scrape, you_follow, use_edge_mutual_followed_by, min_node, max_node,link_multiplier, max_link_size,
}