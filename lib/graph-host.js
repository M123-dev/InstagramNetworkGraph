...
function set_config(req){
  ...
  constants.link_multiplier = values["link_multiplier"];
  constants.min_link_size = values["min_link_size"];
  constants.normal_link_size = values["normal_link_size"];
  constants.max_link_size = values["max_link_size"];
  constants.min_node = values["min_node"];
  constants.max_node = values["max_node"];
  constants.multiply_node = values["multiply_node"];
  constants.attraceForce = values["attraceForce"];
}
